...
const showMillonariesEl = document.getElementById('showMillonaries');
...
showMillonariesEl.addEventListener('click', showMillonarie);
...
function createWealth(wealth) {
  ...
  TotalWealthEl.innerHTML = `<strong>total wealth</strong> ${formatMoney(wealth)}`;
